...
#BLACK = (0,0,0)        #배경 색 처리
padWidth = 480          #게임 창 가로 크기
padHeight = 640         #게임 창 세로 크기
...
def runGame():
 ...
 #------------------------------------------------------------
    onGame = False          #게임실행 ON/OFF 확인 및 설정 변수
    while not onGame:       #게임실행 onGame 변수를 통한 반복 구문 동작(*onGameTrue)
        for event in pygame.event.get():
            if event.type in [pygame.QUIT]:        #pygame.QUIT 신호 및 호출 받게 된다면 게임 종료
